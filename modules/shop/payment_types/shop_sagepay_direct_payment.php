<?
	...
	class Shop_SagePay_Direct_Payment extends Shop_PaymentType
	{
		...
		public function build_payment_form($host_obj)
		{
			...
			$host_obj->add_field('CVV2', 'CVV2', 'left')->renderAs(frm_text)->validation()->fn('trim')->required('Please specify Card Verification Number')->numeric();
			
			$host_obj->add_field('ISSUENUMBER', 'Issue Number', 'right')->comment('Please specify Issue Number, if applicable', 'below')->renderAs(frm_text)->validation()->fn('trim');
		}
