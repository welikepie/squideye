<?php
	 ...
	 */
	class Shop_OrderNotification extends Db_ActiveRecord
	{
		public $table_name = 'shop_order_notifications';
		...
		public $has_many = array(
			'files'=>array('class_name'=>'Db_File', 'foreign_key'=>'master_object_id', 'conditions'=>"(master_object_class='Shop_OrderNotification' or master_object_class='Shop_OrderCustomerNotification') and field='files'", 'order'=>'id', 'delete'=>true)
		);
