<?
	...
	{
		public $implement = 'Db_ListBehavior, Db_FormBehavior, Db_FilterBehavior, Shop_BundleProductUiBehavior, Cms_PageSelector, Backend_FileBrowser';
			...
			else
			{
				...
				foreach ($data as $field=>$value)
				{
					...
					if ($column_info && $column_info->type == db_date)
						$obj->$field = Phpr_DateTime::parse(trim($value), '%x', $timeZoneObj);
					else
						$obj->$field = $value;
				}
