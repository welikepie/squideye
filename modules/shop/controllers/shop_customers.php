<?
	...
	class Shop_Customers extends Backend_Controller
	{
		...
		public $list_search_fields = array('first_name', 'last_name', 'company', 'email', 'shipping_street_addr', 'billing_street_addr', 'billing_city', 'shipping_city', 'billing_country_calculated_join.name', 'shipping_country_calculated_join.name', 'billing_state_calculated_join.name', 'shipping_state_calculated_join.name');
