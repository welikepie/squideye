<?
	...
	class Cms_Templates extends Backend_Controller
	{
		...
		protected function index_onDeleteSelected()
		{
			...
			foreach ($item_ids as $item_id)
			{
				...
				try
				{
					$item = Cms_Template::create()->find($item_id);
					if (!$item)
						throw new Phpr_ApplicationException('Layout with identifier '.$item_id.' not found.');
		...
		{
			if (!Cms_SettingsManager::get()->enable_filebased_templates || !($model instanceof Cms_Template))
				return null;
